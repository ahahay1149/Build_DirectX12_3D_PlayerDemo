...
{
	m_analogMap[ANALOG_IDS::MOVE_H] = static_cast<UINT32>(InputManager::X_ANALOGS::L_X);		
	m_analogMap[ANALOG_IDS::MOVE_V] = static_cast<UINT32>(InputManager::X_ANALOGS::L_Y);		
	m_analogMap[ANALOG_IDS::CAMERA_H] = static_cast<UINT32>(InputManager::X_ANALOGS::R_X);	
	m_analogMap[ANALOG_IDS::CAMERA_V] = static_cast<UINT32>(InputManager::X_ANALOGS::R_Y);	
	m_analogMap[ANALOG_IDS::WHEEL] = static_cast<UINT32>(InputManager::X_ANALOGS::R_TRIGGER);	
